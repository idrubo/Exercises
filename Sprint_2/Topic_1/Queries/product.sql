...
-- 36
SELECT DISTINCT producto.nombre FROM producto
  LEFT JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo
 	WHERE fabricante.nombre='Lenovo';

-- 37
SELECT nombre, codigo, precio, codigo_fabricante FROM producto
  WHERE precio = (
...
-- 41
SELECT DISTINCT fabricante.nombre, producto.nombre FROM producto
  LEFT JOIN fabricante ON producto.codigo_fabricante = fabricante.codigo
