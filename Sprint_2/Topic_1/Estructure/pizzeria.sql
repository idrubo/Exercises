...
CREATE TABLE employee (
  ...
  idempres INT UNSIGNED NOT NULL,
  fName    VARCHAR (50) NOT NULL,
  lName    VARCHAR (50) NOT NULL,
  mName    VARCHAR (50) NOT NULL,
  ...
  CONSTRAINT idemp_idres FOREIGN KEY (idempres)
...
INSERT INTO employee VALUES (1, 1, 'Pedro', 'Pérez',     'López',  '22333444F', '665222333', 'cook');
INSERT INTO employee VALUES (2, 1, 'Ana',   'Miró',      'Adrian', '33111444G', '661999333', 'delivery');
INSERT INTO employee VALUES (3, 2, 'Juan',  'Pérez',     'Lozano', '88333444J', '965111777', 'cook');
INSERT INTO employee VALUES (4, 2, 'Pilar', 'Domínguez', 'Lobo',   '11888111Z', '663222111', 'delivery');
