...
CREATE TABLE works (
  ...
  CONSTRAINT idworemp_idworres_uniq UNIQUE (idworemp, idworres)
);
...
CREATE TABLE purchase (
	...
	idpurham INT UNSIGNED NULL,
	idpurdri INT UNSIGNED NULL,
	idpurpiz INT UNSIGNED NULL,
	...
	nHamb    INT UNSIGNED NULL,
	nDrink   INT UNSIGNED NULL,
	nPizza   INT UNSIGNED NULL,
	...
	CONSTRAINT idpur_idham FOREIGN KEY (idpurham)
	REFERENCES hamburguer (idham)
	ON DELETE RESTRICT
	ON UPDATE CASCADE,

	CONSTRAINT idpur_iddri FOREIGN KEY (idpurdri)
	REFERENCES drink (iddri)
	ON DELETE RESTRICT
	ON UPDATE CASCADE,

	CONSTRAINT idpur_idpiz FOREIGN KEY (idpurpiz)
...
INSERT INTO category VALUES (3, 'Jam', '2020-1-10');
...
INSERT INTO purchase VALUES (1, 1, NULL, 1, 2, 1, 2, '2022-02-01 16:06:00', '2022-02-01 16:26:00', 'atHome', 0, 1, 1, 10.60);
